...
// function for adding/overriding defaults
    ...
    function Calendar(element, options, eventSources) {
        ...
        function changeView(newViewName) {
            //===Mostanser: View Change starts from here
...
//TODO: isFunction, grep ?
    ...
    function MonthView(element, calendar) {
        $('.fc-header-left span.fc-button-prev').removeClass('fc-state-disabled');
        $('.fc-header-left span.fc-button-next').removeClass('fc-state-disabled');
        var t = this;
        ...
        function renderEvents(events, modifiedEventId) {
            ...
            for (evt in events) {
                ...
                if (events[evt]) {
                    ...
                    tm = formatDate(events[evt].start, 'hh:mm tt');
